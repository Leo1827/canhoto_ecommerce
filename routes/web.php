...
Route::middleware(['auth','adminMiddleware'])->group(function(){
    ...
    // CRUD Envíos / Seguimiento de pedidos
        Route::get('admin/shipments', [ShipmentController::class, 'index'])->name('admin.shipments.index');
        Route::get('/shipments/{order}', [ShipmentController::class, 'show'])->name('admin.shipments.show');
        Route::get('/shipments/user/{id}', [ShipmentController::class, 'userOrders'])->name('admin.shipments.user_orders');
        Route::post('/admin/shipments/{order}/status', [ShipmentController::class, 'storeStatus'])->name('admin.shipments.storeStatus');
