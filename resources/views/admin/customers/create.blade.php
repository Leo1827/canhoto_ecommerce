...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Gestão de Clientes</h1>
    ...
    <nav class="text-sm text-gray-600 mb-3" aria-label="Breadcrumb">
        <ol class="list-reset flex items-center space-x-2">
            ...
            <li><span class="mx-1">/</span></li>
            <li class="text-gray-700 font-semibold">Adicionar Novo Cliente</li>
        </ol>
    </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="usertype" id="usertype"
                            class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        <option value="user" {{ old('usertype') == 'user' ? 'selected' : '' }}>Usuário</option>
