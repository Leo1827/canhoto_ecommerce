...
<li>
    <a href=""
        class="flex items-center gap-3 px-4 py-2 rounded-md text-sm transition
            {{ request()->routeIs('admin.categories.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-700 hover:bg-gray-100 hover:text-black' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
...
<li>
    <a href=""
        class="flex items-center gap-3 px-4 py-2 rounded-md text-sm transition
            {{ request()->routeIs('admin.wineries.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-700 hover:bg-gray-100 hover:text-black' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M4 4h16v16H4V4z"/>
        </svg>
...
<li>
    <a href=""
        class="flex items-center gap-3 px-4 py-2 rounded-md text-sm transition
            {{ request()->routeIs('admin.wine_types.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-700 hover:bg-gray-100 hover:text-black' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
...
<li>
    <a href=""
        class="flex items-center gap-3 px-4 py-2 rounded-md text-sm transition
            {{ request()->routeIs('admin.vintages.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-700 hover:bg-gray-100 hover:text-black' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
...
<li>
    <a href=""
        class="flex items-center gap-3 px-4 py-2 rounded-md text-sm transition
            {{ request()->routeIs('admin.conditions.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-700 hover:bg-gray-100 hover:text-black' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
