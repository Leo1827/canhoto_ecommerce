            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->usertype == 'user')
                        <x-nav-link href="" :active="request()->routeIs('user.test', 'user.test.show')">
                            {{ __('Pruebas') }}
                        </x-nav-link>

                        <x-nav-link href="" :active="request()->routeIs('user.result*')">
                            {{ __('Resultados') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                ...
                {{-- Admin links --}}
                @if (Auth::user()->usertype == 'user')
                    <x-responsive-nav-link href="test" :active="request()->routeIs('user.test')">
                        {{ __('Pruebas') }}
                    </x-responsive-nav-link>

                    <x-responsive-nav-link href="result" :active="request()->routeIs('user.result')">
                        {{ __('Resultado') }}
                    </x-responsive-nav-link>
